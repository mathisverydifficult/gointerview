...
(
    ...
    CHAT_ST_DT       DATE            NOT NULL, 
    CHAT_END_DT      DATE            NOT NULL, 
    CHAT_FINAL_DT    DATE            NOT NULL, 
...
(
    ...
    Q_GRP_SEQ      VARCHAR2(20)      NOT NULL, 
...
(
    ...
    INFO_INST_DT     DATE              NOT NULL, 
    INFO_END_DT      VARCHAR2(10)      NOT NULL, 
